...
hero:
  ...
  tagline: Install @chat-service/sdk, import ChatModule.forRoot(), and add chat to any NestJS backend
  actions:
    - theme: brand
...
features:
  - title: SDK/Plugin Pattern
    details: Install @chat-service/sdk, import ChatModule.forRoot() into any NestJS project. Inject your own auth, users, and storage.
