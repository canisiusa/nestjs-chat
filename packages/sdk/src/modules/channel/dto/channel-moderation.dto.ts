...
export class BanUserDto {
  @ApiPropertyOptional({
    ...
    example: 'Repeated spam messages',
  })
  @IsString()
  @IsOptional()
  description?: string;
...
export class SetPushTriggerDto {
  @ApiProperty({
    description: 'Push notification trigger option',
...
export class SetCountPreferenceDto {
  @ApiProperty({
    description: 'Unread count preference',
    example: 'all',
    enum: ['all', 'unread_message_count_only', 'off'],
  })
...
export class HideChannelDto {
  @ApiPropertyOptional({
    description: 'Whether to also hide previous messages when hiding the channel',
    example: false,
  })
  @IsBoolean()
  @IsOptional()
...
export class ChannelMetadataDto {
  @ApiProperty({
    description: 'Key-value metadata to attach to the channel',
    example: { theme: 'dark', priority: 'high' },
  })
  @IsObject()
...
export class ReportDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'User is sending repeated unsolicited messages',
  })
  @IsString()
  @IsOptional()
  description?: string;
